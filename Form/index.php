      ...
      <div class="modal-body">
        <form id="formActionEdit">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group mt-3">
                          <span class="input-group-text" id="basic-addon3">Course</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group mt-3">
                          <span class="input-group-text" id="basic-addon3">Cloud Computing</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group mt-3">
                          <span class="input-group-text" id="basic-addon3">Complier Degin</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group mt-3">
                          <span class="input-group-text" id="basic-addon3">IOT</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group mt-3">
                          <span class="input-group-text" id="basic-addon3">Software Engineering</span>
